...
export default function SchedulePage() {
	...
	const timelineData: TimelineData = {
		1: [
			{ time: "9:30 – 11:00", event: "Inauguration", description: "Opening ceremony of Sabrang 2025", location: "Admin", category: "Ceremony" },
			...
			{ time: "11:00 – 12:00", event: "Focus", description: "Concentration and mindfulness session", location: "TBD", category: "Wellness" },
			{ time: "11:00 – 3:00", event: "Valorant", description: "Gaming tournament", location: "IM 101", category: "Gaming" },
			{ time: "11:30 – 1:30", event: "Echoes of Noor", description: "Cultural performance", location: "Main Stage", category: "Cultural" },
			{ time: "2:00 – 3:00", event: "In Convo With", description: "Interactive discussion session", location: "IM", category: "Discussion" },
			{ time: "3:30 – 6:00", event: "Verse Vaad", description: "Poetry and literary event", location: "Main Stage", category: "Cultural" },
		...
		2: [
			{ time: "9:00 – 2:00", event: "BBW", description: "Bidding Before Wicket - cricket auction event", location: "IM amphi", category: "Sports" },
			{ time: "11:00 – 2:00", event: "Free Fire", description: "Mobile gaming tournament", location: "IM 102", category: "Gaming" },
			{ time: "12:00 – 1:00", event: "In Convo", description: "Interactive discussion session", location: "IET amphi", category: "Discussion" },
			{ time: "11:30 – 1:30", event: "Step Up", description: "Dance competition", location: "Main Stage", category: "Dance" },
			{ time: "2:00 – 4:00", event: "Clay Modelling", description: "Art and craft workshop", location: "Tech Lawn", category: "Art" },
			{ time: "3:30 – 5:30", event: "Band Jam", description: "Musical performance", location: "Main Stage", category: "Music" },
			{ time: "5:30 – 8:00", event: "Dance Battle", description: "Dance competition finals", location: "Main Stage", category: "Dance" },
			{ time: "9:00 – 10:00", event: "Aman collectives", description: "Cultural group performance", location: "Main stage", category: "Cultural" },
			{ time: "10:00 – 10:30", event: "DJ night", description: "Music and dance party", location: "Main stage", category: "Entertainment" },
		],
		3: [
			{ time: "9:00 – 11:00", event: "Courtroom", description: "Debate and legal discussion", location: "IM amphi", category: "Debate" },
			{ time: "11:00 – 3:00", event: "BGMI", description: "Mobile gaming tournament", location: "IM 101", category: "Gaming" },
			{ time: "11:00 – 1:00", event: "Dumb Show", description: "Silent performance art", location: "IET amphi", category: "Performance" },
