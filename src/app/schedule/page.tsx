...
export default function SchedulePage() {
	...
	const timelineData: TimelineData = {
		...
		2: [
			{ time: "9:00 – 2:00", event: "Bidding Before Wicket", description: "Cricket auction and bidding event", location: "IET Amphi", category: "Sports" },
			{ time: "1:00 – 5:00", event: "Free Fire", description: "Mobile gaming tournament", location: "IM 102", category: "Gaming" },
			...
			{ time: "3:00 – 4:30", event: "Clay Modelling", description: "Art and craft workshop", location: "Tech Lawn", category: "Art" },
			{ time: "3:00 – 5:00", event: "Band Jam", description: "Musical performance", location: "Main Stage", category: "Music" },
			{ time: "5:30 – 7:30", event: "Dance Battle", description: "Dance competition finals", location: "Main Stage", category: "Dance" },
			{ time: "8:30 – 9:30", event: "AMAN'S COLLECTIVE", description: "A Live Band", location: "Main Stage", category: "Music" },
