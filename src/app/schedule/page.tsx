...
export default function SchedulePage() {
	...
	const timelineData: TimelineData = {
		1: [
			{ time: "9:00 – 10:00", event: "Inauguration", description: "Opening ceremony of Sabrang 2025", location: "Main Stage", category: "Ceremony" },
			...
			{ time: "2:00 – 3:30", event: "In convo. With", description: "Interactive discussion session", location: "Tech Lawn", category: "Discussion" },
		...
		2: [
			{ time: "9:00 – 2:00", event: "Bidding Before Wicket", description: "Cricket auction event", location: "IET amphi", category: "Sports" },
			{ time: "11:00 – 2:00", event: "Free Fire", description: "Mobile gaming tournament", location: "IM 102", category: "Gaming" },
			{ time: "11:30 – 1:30", event: "Courtroom", description: "Debate and legal discussion", location: "Amphitheatre", category: "Debate" },
			...
			{ time: "4:00 – 6:00", event: "Band Jam", description: "Musical performance", location: "Main Stage", category: "Music" },
			{ time: "6:00 – 8:30", event: "Dance Battle", description: "Dance competition finals", location: "Main Stage", category: "Dance" },
			{ time: "9:00 – 10:00", event: "Aman collectives", description: "Cultural group performance", location: "Main stage", category: "Cultural" },
			{ time: "10:00 – 10:45", event: "DJ night", description: "Music and dance party", location: "Main stage", category: "Entertainment" },
		],
		3: [
			{ time: "9:00 – 11:00", event: "Focus", description: "Concentration and mindfulness event", location: "IET amphi", category: "Wellness" },
