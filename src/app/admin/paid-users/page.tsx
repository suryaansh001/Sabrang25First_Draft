...
function PaidUsersPage() {
  ...
  return (
    <div className="min-h-screen pt-20 pb-16 px-16 sm:px-20 lg:px-32 xl:px-40 2xl:px-48 text-white font-sans bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900">
